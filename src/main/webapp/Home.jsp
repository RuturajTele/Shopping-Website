                    ...
                    <div class="col-lg-6 col-md-5">
                        <div class="header__top__right">
                            <div class="header__top__links">
                                ...
                                <% } else { %>
                                <a href="LogoutController" class="col-lg-6 col-md-5 header__top__links logout-button">Logout</a>
                    ...
                    <div class="row">
                        <div class="col-xl-5 col-lg-7 col-md-8">
                            <div class="hero__text">
                                ...
                                <p>Wear it with the ultimate smile</p>
                                <a href="Productontroller" class="primary-btn">Shop now</a>
